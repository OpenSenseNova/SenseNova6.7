...
> 📝 **尚未申请 SenseNova API Key？** 请前往 [SenseNova 官网](https://console.sensecore.cn) 完成注册与实名认证，并在 **管理中心 → API-Key 管理** 中创建 Key。详细步骤参见主 README 的 [🚀 快速开始 → API Key 申请](../README_CN.md#api-key-申请) 章节。

---

如有任何问题，欢迎前往 [GitHub Issues](https://github.com/SenseTime-FVG/agent_pack/issues) 与我们交流。

[← 返回主 README](../README_CN.md)
