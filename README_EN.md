...
#### [💻 Detailed Windows install & usage →](docs/install-windows_EN.md)

#### [🍎 Detailed macOS install & usage →](docs/install-macos_EN.md)
...
3. **Full log**: log paths are listed in [FAQ](docs/faq_EN.md) Q1

---

### [🎓 Advanced Guide →](docs/advanced_EN.md)
...
- API documentation: [docs/API_EN.md](docs/API_EN.md)
